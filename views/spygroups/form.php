			...
			<div class="col-sm-12">
				<div class="fpbx-container">
                    ...
                    <div class="element-container">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-3 control-label">
                                                    <label class="control-label" for="spycode">Group Name</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span id="spycode-help" class="help-block fpbx-help-block">Name of the Spy Group. Name should only contain letters, numbers, dashes (-) or underscores (_)</span>
                            </div>
                        </div>
                    ...
                    <div class="element-container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-3 control-label">
                                            <label for="auth">Group Targets</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              <span id="passcode-help" class="help-block fpbx-help-block general-find">Select extensions that will be spy targets associated with this group. Any Spy Code using this group will be able to spy on the selected target extensions</span>
                            </div>
                        </div>
                    </div>
