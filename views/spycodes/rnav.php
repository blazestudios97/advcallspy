	...
	<div class="btn-group">
	  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		...
		<ul class="dropdown-menu">
			...
			<li><a href="?display=advcallspy&amp;view=form"><i class="fa fa-plus"></i>&nbsp;<?php echo _("Add Spy Code") ?></a></li>
		</ul>
    </div>
</div>
<table id="spycodernav"
			 data-url="ajax.php?module=advcallspy&amp;command=getJSON&amp;jdata=scgrid"
			 data-cache="false"
	 ...
	 <thead>
					 <tr>
					 <th data-field="spycode" data-sortable="true"><?php echo _("Spy Codes")?></th>
...
<script type="text/javascript">
	$("#spycodernav").on('click-row.bs.table',function(e,row,elem){
		window.location = '?display=advcallspy&view=form&extdisplay='+row['exten'];
	})
</script>